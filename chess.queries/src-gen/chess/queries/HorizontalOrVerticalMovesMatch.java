...
/**
 * Pattern-specific match representation of the chess.queries.horizontalOrVerticalMoves pattern,
 * to be used in conjunction with {@link HorizontalOrVerticalMovesMatcher}.
 * 
...
public abstract class HorizontalOrVerticalMovesMatch extends BasePatternMatch {
  ...
  private HorizontalOrVerticalMovesMatch(final Piece pPiece, final Square pSquare) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return HorizontalOrVerticalMovesMatch.parameterNames;
  }
  ...
  @Override
  public HorizontalOrVerticalMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HorizontalOrVerticalMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    HorizontalOrVerticalMovesMatch other = (HorizontalOrVerticalMovesMatch) obj;
  ...
  @Override
  public HorizontalOrVerticalMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static HorizontalOrVerticalMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static HorizontalOrVerticalMovesMatch newMutableMatch(final Piece pPiece, final Square pSquare) {
   ...
   * 
   */
  public static HorizontalOrVerticalMovesMatch newMatch(final Piece pPiece, final Square pSquare) {
    return new Immutable(pPiece, pSquare);
  }
  
  private static final class Mutable extends HorizontalOrVerticalMovesMatch {
  ...
  private static final class Immutable extends HorizontalOrVerticalMovesMatch {
