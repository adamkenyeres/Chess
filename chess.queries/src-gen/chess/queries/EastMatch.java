...
/**
 * Pattern-specific match representation of the chess.queries.east pattern,
...
public abstract class EastMatch extends BasePatternMatch {
  ...
  private EastMatch(final Square pSquareE, final Square pSquareW) {
   ...
   * 
   */
  public static EastMatch newMutableMatch(final Square pSquareE, final Square pSquareW) {
   ...
   * 
   */
  public static EastMatch newMatch(final Square pSquareE, final Square pSquareW) {
