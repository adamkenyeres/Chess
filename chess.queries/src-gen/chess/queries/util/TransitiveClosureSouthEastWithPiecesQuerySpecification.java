...
/**
 * A pattern-specific query specification that can instantiate TransitiveClosureSouthEastWithPiecesMatcher in a type-safe way.
 * 
 * @see TransitiveClosureSouthEastWithPiecesMatcher
 * @see TransitiveClosureSouthEastWithPiecesMatch
 * 
 */
@SuppressWarnings("all")
public final class TransitiveClosureSouthEastWithPiecesQuerySpecification extends BaseGeneratedEMFQuerySpecification<TransitiveClosureSouthEastWithPiecesMatcher> {
  private TransitiveClosureSouthEastWithPiecesQuerySpecification() {
   ...
   * 
   */
  public static TransitiveClosureSouthEastWithPiecesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TransitiveClosureSouthEastWithPiecesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TransitiveClosureSouthEastWithPiecesMatcher.on(engine);
  }
  
  @Override
  public TransitiveClosureSouthEastWithPiecesMatch newEmptyMatch() {
    return TransitiveClosureSouthEastWithPiecesMatch.newEmptyMatch();
  }
  
  @Override
  public TransitiveClosureSouthEastWithPiecesMatch newMatch(final Object... parameters) {
    return TransitiveClosureSouthEastWithPiecesMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TransitiveClosureSouthEastWithPiecesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TransitiveClosureSouthEastWithPiecesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TransitiveClosureSouthEastWithPiecesQuerySpecification INSTANCE = new TransitiveClosureSouthEastWithPiecesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TransitiveClosureSouthEastWithPiecesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.transitiveClosureSouthEastWithPieces";
    }
      ...
      try {
      	{
      		...
      		new BinaryTransitiveClosure(body, new FlatTuple(var_start, var_square), SEQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern transitiveClosureSouthEastWithPieces";
      		                            }
  ...
  private static boolean evaluateExpression_1_1(final Integer squareId, final Integer startId) {
    boolean _greaterThan = (squareId.compareTo(startId) > 0);
    return _greaterThan;
  }
  
  private static boolean evaluateExpression_1_2(final Integer endId, final Integer squareId) {
    boolean _lessThan = (squareId.compareTo(endId) < 0);
    return _lessThan;
  }
