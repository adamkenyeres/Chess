...
public final class WQuerySpecification extends BaseGeneratedEMFQuerySpecification<WMatcher> {
  ...
  public WMatch newMatch(final Object... parameters) {
    return WMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_target, var_source), EastQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	                {
