...
/**
 * A pattern-specific query specification that can instantiate TransitiveClosureEastWithPiecesMatcher in a type-safe way.
 * 
 * @see TransitiveClosureEastWithPiecesMatcher
 * @see TransitiveClosureEastWithPiecesMatch
 * 
 */
@SuppressWarnings("all")
public final class TransitiveClosureEastWithPiecesQuerySpecification extends BaseGeneratedEMFQuerySpecification<TransitiveClosureEastWithPiecesMatcher> {
  private TransitiveClosureEastWithPiecesQuerySpecification() {
   ...
   * 
   */
  public static TransitiveClosureEastWithPiecesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TransitiveClosureEastWithPiecesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TransitiveClosureEastWithPiecesMatcher.on(engine);
  }
  
  @Override
  public TransitiveClosureEastWithPiecesMatch newEmptyMatch() {
    return TransitiveClosureEastWithPiecesMatch.newEmptyMatch();
  }
  
  @Override
  public TransitiveClosureEastWithPiecesMatch newMatch(final Object... parameters) {
    return TransitiveClosureEastWithPiecesMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TransitiveClosureEastWithPiecesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TransitiveClosureEastWithPiecesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TransitiveClosureEastWithPiecesQuerySpecification INSTANCE = new TransitiveClosureEastWithPiecesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TransitiveClosureEastWithPiecesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.transitiveClosureEastWithPieces";
    }
      ...
      try {
      	{
      		...
      		// 	find E +(start, square)
      		new BinaryTransitiveClosure(body, new FlatTuple(var_start, var_square), EQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern transitiveClosureEastWithPieces";
      		                            }
