...
/**
 * A match processor tailored for the chess.queries.movesSouthWest pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class MovesSouthWestProcessor implements IMatchProcessor<MovesSouthWestMatch> {
  /**
  ...
  @Override
  public void process(final MovesSouthWestMatch match) {
