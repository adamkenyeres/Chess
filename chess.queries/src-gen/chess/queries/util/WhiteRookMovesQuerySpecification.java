...
/**
 * A pattern-specific query specification that can instantiate WhiteRookMovesMatcher in a type-safe way.
 * 
...
public final class WhiteRookMovesQuerySpecification extends BaseGeneratedEMFQuerySpecification<WhiteRookMovesMatcher> {
  private WhiteRookMovesQuerySpecification() {
   ...
   * 
   */
  public static WhiteRookMovesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected WhiteRookMovesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return WhiteRookMovesMatcher.on(engine);
  }
  
  @Override
  public WhiteRookMovesMatch newEmptyMatch() {
    return WhiteRookMovesMatch.newEmptyMatch();
  }
  
  @Override
  public WhiteRookMovesMatch newMatch(final Object... parameters) {
    return WhiteRookMovesMatch.newMatch((chessdiagram.Rook) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Chess) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WhiteRookMovesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link WhiteRookMovesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static WhiteRookMovesQuerySpecification INSTANCE = new WhiteRookMovesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static WhiteRookMovesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern whiteRookMoves";
      		                            }
      		...
      		new TypeConstraint(body, new FlatTuple(var_rook, var__virtual_2_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://example.com/chessdiagram", "Piece", "colour")));
