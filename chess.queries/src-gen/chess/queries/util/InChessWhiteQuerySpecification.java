...
public final class InChessWhiteQuerySpecification extends BaseGeneratedEMFQuerySpecification<InChessWhiteMatcher> {
  ...
  public InChessWhiteMatch newMatch(final Object... parameters) {
    return InChessWhiteMatch.newMatch((chessdiagram.King) parameters[0], (chessdiagram.Piece) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_piece, var_kingSquare), BlackMovesQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
