...
/**
 * A match processor tailored for the chess.queries.movesNorthEast pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class MovesNorthEastProcessor implements IMatchProcessor<MovesNorthEastMatch> {
  /**
  ...
  @Override
  public void process(final MovesNorthEastMatch match) {
