...
public final class EQuerySpecification extends BaseGeneratedEMFQuerySpecification<EMatcher> {
  ...
  public EMatch newMatch(final Object... parameters) {
    return EMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_source, var_target), EastQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	                {
