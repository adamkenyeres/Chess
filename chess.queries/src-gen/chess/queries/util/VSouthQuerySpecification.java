...
/**
 * A pattern-specific query specification that can instantiate VSouthMatcher in a type-safe way.
 * 
 * @see VSouthMatcher
 * @see VSouthMatch
 * 
...
public final class VSouthQuerySpecification extends BaseGeneratedEMFQuerySpecification<VSouthMatcher> {
  private VSouthQuerySpecification() {
   ...
   * 
   */
  public static VSouthQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected VSouthMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return VSouthMatcher.on(engine);
  }
  
  @Override
  public VSouthMatch newEmptyMatch() {
    return VSouthMatch.newEmptyMatch();
  }
  
  @Override
  public VSouthMatch newMatch(final Object... parameters) {
    return VSouthMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VSouthQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link VSouthQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static VSouthQuerySpecification INSTANCE = new VSouthQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static VSouthQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.vSouth";
    }
