...
/**
 * A match processor tailored for the chess.queries.movesNorth pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class MovesNorthProcessor implements IMatchProcessor<MovesNorthMatch> {
  /**
  ...
  @Override
  public void process(final MovesNorthMatch match) {
