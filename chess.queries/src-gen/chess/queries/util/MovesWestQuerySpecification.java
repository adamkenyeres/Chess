...
/**
 * A pattern-specific query specification that can instantiate MovesWestMatcher in a type-safe way.
 * 
...
public final class MovesWestQuerySpecification extends BaseGeneratedEMFQuerySpecification<MovesWestMatcher> {
  private MovesWestQuerySpecification() {
   ...
   * 
   */
  public static MovesWestQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected MovesWestMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return MovesWestMatcher.on(engine);
  }
  
  @Override
  public MovesWestMatch newEmptyMatch() {
    return MovesWestMatch.newEmptyMatch();
  }
  
  @Override
  public MovesWestMatch newMatch(final Object... parameters) {
    return MovesWestMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MovesWestQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link MovesWestQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static MovesWestQuerySpecification INSTANCE = new MovesWestQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static MovesWestQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern movesWest";
      		                            }
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	find hWest(squareStart, squareMiddle)
      		new PositivePatternCall(body, new FlatTuple(var_squareStart, var_squareMiddle), HWestQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	C == count find transitiveClosureEastWithPieces(squareMiddle, squareStart, _)
      		PVariable var__virtual_3_ = body.getOrCreateVariableByName(".virtual{3}");
      		new PatternMatchCounter(body, new FlatTuple(var_squareMiddle, var_squareStart, var___0_), TransitiveClosureEastWithPiecesQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_3_);
