...
/**
 * A pattern-specific query specification that can instantiate WhiteKnightMovesMatcher in a type-safe way.
 * 
 * @see WhiteKnightMovesMatcher
 * @see WhiteKnightMovesMatch
 * 
 */
@SuppressWarnings("all")
public final class WhiteKnightMovesQuerySpecification extends BaseGeneratedEMFQuerySpecification<WhiteKnightMovesMatcher> {
  private WhiteKnightMovesQuerySpecification() {
   ...
   * 
   */
  public static WhiteKnightMovesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected WhiteKnightMovesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return WhiteKnightMovesMatcher.on(engine);
  }
  
  @Override
  public WhiteKnightMovesMatch newEmptyMatch() {
    return WhiteKnightMovesMatch.newEmptyMatch();
  }
  
  @Override
  public WhiteKnightMovesMatch newMatch(final Object... parameters) {
    return WhiteKnightMovesMatch.newMatch((chessdiagram.Knight) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Chess) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link WhiteKnightMovesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link WhiteKnightMovesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static WhiteKnightMovesQuerySpecification INSTANCE = new WhiteKnightMovesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static WhiteKnightMovesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.whiteKnightMoves";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern whiteKnightMoves";
      		                            }
      		                        ...
      		                        },  null); // 	Knight.colour(piece, ::White)
