...
/**
 * A match processor tailored for the chess.queries.whiteRookMoves pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class WhiteRookMovesProcessor implements IMatchProcessor<WhiteRookMovesMatch> {
  /**
  ...
  @Override
  public void process(final WhiteRookMovesMatch match) {
