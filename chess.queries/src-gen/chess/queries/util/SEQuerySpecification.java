...
public final class SEQuerySpecification extends BaseGeneratedEMFQuerySpecification<SEMatcher> {
  ...
  public SEMatch newMatch(final Object... parameters) {
    return SEMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_target, var_source), NorthWestQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	                {
