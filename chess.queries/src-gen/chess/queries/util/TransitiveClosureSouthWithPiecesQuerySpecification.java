...
/**
 * A pattern-specific query specification that can instantiate TransitiveClosureSouthWithPiecesMatcher in a type-safe way.
 * 
 * @see TransitiveClosureSouthWithPiecesMatcher
 * @see TransitiveClosureSouthWithPiecesMatch
 * 
 */
@SuppressWarnings("all")
public final class TransitiveClosureSouthWithPiecesQuerySpecification extends BaseGeneratedEMFQuerySpecification<TransitiveClosureSouthWithPiecesMatcher> {
  private TransitiveClosureSouthWithPiecesQuerySpecification() {
   ...
   * 
   */
  public static TransitiveClosureSouthWithPiecesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TransitiveClosureSouthWithPiecesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TransitiveClosureSouthWithPiecesMatcher.on(engine);
  }
  
  @Override
  public TransitiveClosureSouthWithPiecesMatch newEmptyMatch() {
    return TransitiveClosureSouthWithPiecesMatch.newEmptyMatch();
  }
  
  @Override
  public TransitiveClosureSouthWithPiecesMatch newMatch(final Object... parameters) {
    return TransitiveClosureSouthWithPiecesMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TransitiveClosureSouthWithPiecesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TransitiveClosureSouthWithPiecesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TransitiveClosureSouthWithPiecesQuerySpecification INSTANCE = new TransitiveClosureSouthWithPiecesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TransitiveClosureSouthWithPiecesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.transitiveClosureSouthWithPieces";
    }
      ...
      try {
      	{
      		...
      		// 	find S +(start, square)
      		new BinaryTransitiveClosure(body, new FlatTuple(var_start, var_square), SQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern transitiveClosureSouthWithPieces";
      		                            }
