...
/**
 * A pattern-specific query specification that can instantiate MovesNorthMatcher in a type-safe way.
 * 
 * @see MovesNorthMatcher
 * @see MovesNorthMatch
 * 
 */
@SuppressWarnings("all")
public final class MovesNorthQuerySpecification extends BaseGeneratedEMFQuerySpecification<MovesNorthMatcher> {
  private MovesNorthQuerySpecification() {
   ...
   * 
   */
  public static MovesNorthQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected MovesNorthMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return MovesNorthMatcher.on(engine);
  }
  
  @Override
  public MovesNorthMatch newEmptyMatch() {
    return MovesNorthMatch.newEmptyMatch();
  }
  
  @Override
  public MovesNorthMatch newMatch(final Object... parameters) {
    return MovesNorthMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MovesNorthQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link MovesNorthQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static MovesNorthQuerySpecification INSTANCE = new MovesNorthQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static MovesNorthQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.movesNorth";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern movesNorth";
      		                            }
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	find vNorth(squareStart, squareMiddle)
      		new PositivePatternCall(body, new FlatTuple(var_squareStart, var_squareMiddle), VNorthQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	C == count find	transitiveClosureSouthWithPieces(squareMiddle, squareStart, _)
      		PVariable var__virtual_3_ = body.getOrCreateVariableByName(".virtual{3}");
      		new PatternMatchCounter(body, new FlatTuple(var_squareMiddle, var_squareStart, var___0_), TransitiveClosureSouthWithPiecesQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_3_);
