...
/**
 * A pattern-specific query specification that can instantiate MovesNorthWestMatcher in a type-safe way.
 * 
 * @see MovesNorthWestMatcher
 * @see MovesNorthWestMatch
 * 
 */
@SuppressWarnings("all")
public final class MovesNorthWestQuerySpecification extends BaseGeneratedEMFQuerySpecification<MovesNorthWestMatcher> {
  private MovesNorthWestQuerySpecification() {
   ...
   * 
   */
  public static MovesNorthWestQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected MovesNorthWestMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return MovesNorthWestMatcher.on(engine);
  }
  
  @Override
  public MovesNorthWestMatch newEmptyMatch() {
    return MovesNorthWestMatch.newEmptyMatch();
  }
  
  @Override
  public MovesNorthWestMatch newMatch(final Object... parameters) {
    return MovesNorthWestMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MovesNorthWestQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link MovesNorthWestQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static MovesNorthWestQuerySpecification INSTANCE = new MovesNorthWestQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static MovesNorthWestQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.movesNorthWest";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern movesNorthWest";
      		                            }
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	find northWestTransitiveClouser(squareStart, squareMiddle)
      		new PositivePatternCall(body, new FlatTuple(var_squareStart, var_squareMiddle), NorthWestTransitiveClouserQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	C == count find	transitiveClosureSouthEastWithPieces(squareMiddle, squareStart, _)
      		PVariable var__virtual_3_ = body.getOrCreateVariableByName(".virtual{3}");
      		new PatternMatchCounter(body, new FlatTuple(var_squareMiddle, var_squareStart, var___0_), TransitiveClosureSouthEastWithPiecesQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_3_);
