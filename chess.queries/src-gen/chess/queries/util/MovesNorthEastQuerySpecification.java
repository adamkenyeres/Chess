...
/**
 * A pattern-specific query specification that can instantiate MovesNorthEastMatcher in a type-safe way.
 * 
 * @see MovesNorthEastMatcher
 * @see MovesNorthEastMatch
 * 
 */
@SuppressWarnings("all")
public final class MovesNorthEastQuerySpecification extends BaseGeneratedEMFQuerySpecification<MovesNorthEastMatcher> {
  private MovesNorthEastQuerySpecification() {
   ...
   * 
   */
  public static MovesNorthEastQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected MovesNorthEastMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return MovesNorthEastMatcher.on(engine);
  }
  
  @Override
  public MovesNorthEastMatch newEmptyMatch() {
    return MovesNorthEastMatch.newEmptyMatch();
  }
  
  @Override
  public MovesNorthEastMatch newMatch(final Object... parameters) {
    return MovesNorthEastMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MovesNorthEastQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link MovesNorthEastQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static MovesNorthEastQuerySpecification INSTANCE = new MovesNorthEastQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static MovesNorthEastQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.movesNorthEast";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern movesNorthEast";
      		                            }
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	find northEastTransitiveClouser(squareStart, squareMiddle)
      		new PositivePatternCall(body, new FlatTuple(var_squareStart, var_squareMiddle), NorthEastTransitiveClouserQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	C == count find	transitiveClosureSouthWestWithPieces(squareMiddle, squareStart, _)
      		PVariable var__virtual_3_ = body.getOrCreateVariableByName(".virtual{3}");
      		new PatternMatchCounter(body, new FlatTuple(var_squareMiddle, var_squareStart, var___0_), TransitiveClosureSouthWestWithPiecesQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_3_);
  ...
  private static boolean evaluateExpression_1_3(final Integer endId, final Integer middleId) {
    boolean _greaterEqualsThan = (middleId.compareTo(endId) >= 0);
