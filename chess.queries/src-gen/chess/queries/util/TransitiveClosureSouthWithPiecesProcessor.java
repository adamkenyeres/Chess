...
/**
 * A match processor tailored for the chess.queries.transitiveClosureSouthWithPieces pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class TransitiveClosureSouthWithPiecesProcessor implements IMatchProcessor<TransitiveClosureSouthWithPiecesMatch> {
  /**
  ...
  @Override
  public void process(final TransitiveClosureSouthWithPiecesMatch match) {
