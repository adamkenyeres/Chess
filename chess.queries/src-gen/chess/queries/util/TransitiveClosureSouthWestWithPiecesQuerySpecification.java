...
/**
 * A pattern-specific query specification that can instantiate TransitiveClosureSouthWestWithPiecesMatcher in a type-safe way.
 * 
 * @see TransitiveClosureSouthWestWithPiecesMatcher
 * @see TransitiveClosureSouthWestWithPiecesMatch
 * 
 */
@SuppressWarnings("all")
public final class TransitiveClosureSouthWestWithPiecesQuerySpecification extends BaseGeneratedEMFQuerySpecification<TransitiveClosureSouthWestWithPiecesMatcher> {
  private TransitiveClosureSouthWestWithPiecesQuerySpecification() {
   ...
   * 
   */
  public static TransitiveClosureSouthWestWithPiecesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TransitiveClosureSouthWestWithPiecesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TransitiveClosureSouthWestWithPiecesMatcher.on(engine);
  }
  
  @Override
  public TransitiveClosureSouthWestWithPiecesMatch newEmptyMatch() {
    return TransitiveClosureSouthWestWithPiecesMatch.newEmptyMatch();
  }
  
  @Override
  public TransitiveClosureSouthWestWithPiecesMatch newMatch(final Object... parameters) {
    return TransitiveClosureSouthWestWithPiecesMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TransitiveClosureSouthWestWithPiecesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TransitiveClosureSouthWestWithPiecesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TransitiveClosureSouthWestWithPiecesQuerySpecification INSTANCE = new TransitiveClosureSouthWestWithPiecesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TransitiveClosureSouthWestWithPiecesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.transitiveClosureSouthWestWithPieces";
    }
      ...
      try {
      	{
      		...
      		new BinaryTransitiveClosure(body, new FlatTuple(var_start, var_square), SWQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern transitiveClosureSouthWestWithPieces";
      		                            }
