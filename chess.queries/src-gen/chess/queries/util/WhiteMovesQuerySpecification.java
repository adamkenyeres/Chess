...
public final class WhiteMovesQuerySpecification extends BaseGeneratedEMFQuerySpecification<WhiteMovesMatcher> {
  ...
  public WhiteMovesMatch newMatch(final Object... parameters) {
    return WhiteMovesMatch.newMatch((chessdiagram.Piece) parameters[0], (chessdiagram.Square) parameters[1]);
  }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_piece, var_square), WhitePawnMovesQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
      		PBody body = new PBody(this);
      		...
      		new PositivePatternCall(body, new FlatTuple(var_piece, var_square), WhiteKnightMovesQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
      		PBody body = new PBody(this);
