...
/**
 * A pattern-specific query specification that can instantiate AllMovesNoChessMatcher in a type-safe way.
 * 
 * @see AllMovesNoChessMatcher
 * @see AllMovesNoChessMatch
 * 
 */
@SuppressWarnings("all")
public final class AllMovesNoChessQuerySpecification extends BaseGeneratedEMFQuerySpecification<AllMovesNoChessMatcher> {
  private AllMovesNoChessQuerySpecification() {
   ...
   * 
   */
  public static AllMovesNoChessQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected AllMovesNoChessMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return AllMovesNoChessMatcher.on(engine);
  }
  
  @Override
  public AllMovesNoChessMatch newEmptyMatch() {
    return AllMovesNoChessMatch.newEmptyMatch();
  }
  
  @Override
  public AllMovesNoChessMatch newMatch(final Object... parameters) {
    return AllMovesNoChessMatch.newMatch((chessdiagram.Piece) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Chess) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link AllMovesNoChessQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link AllMovesNoChessQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static AllMovesNoChessQuerySpecification INSTANCE = new AllMovesNoChessQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static AllMovesNoChessQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.allMovesNoChess";
    }
      ...
      try {
      	{
      		...
      		new PositivePatternCall(body, new FlatTuple(var_piece, var_square, var_chess), WhiteMovesQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
      	{
      		PBody body = new PBody(this);
      		...
      		new PositivePatternCall(body, new FlatTuple(var_piece, var_square, var_chess), BlackMovesQuerySpecification.instance().getInternalQueryRepresentation());
      		bodies.add(body);
      	}
