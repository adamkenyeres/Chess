...
/**
 * A pattern-specific query specification that can instantiate TransitiveClosureNorthEastWithPiecesMatcher in a type-safe way.
 * 
 * @see TransitiveClosureNorthEastWithPiecesMatcher
 * @see TransitiveClosureNorthEastWithPiecesMatch
 * 
 */
@SuppressWarnings("all")
public final class TransitiveClosureNorthEastWithPiecesQuerySpecification extends BaseGeneratedEMFQuerySpecification<TransitiveClosureNorthEastWithPiecesMatcher> {
  private TransitiveClosureNorthEastWithPiecesQuerySpecification() {
   ...
   * 
   */
  public static TransitiveClosureNorthEastWithPiecesQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected TransitiveClosureNorthEastWithPiecesMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return TransitiveClosureNorthEastWithPiecesMatcher.on(engine);
  }
  
  @Override
  public TransitiveClosureNorthEastWithPiecesMatch newEmptyMatch() {
    return TransitiveClosureNorthEastWithPiecesMatch.newEmptyMatch();
  }
  
  @Override
  public TransitiveClosureNorthEastWithPiecesMatch newMatch(final Object... parameters) {
    return TransitiveClosureNorthEastWithPiecesMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link TransitiveClosureNorthEastWithPiecesQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link TransitiveClosureNorthEastWithPiecesQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static TransitiveClosureNorthEastWithPiecesQuerySpecification INSTANCE = new TransitiveClosureNorthEastWithPiecesQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static TransitiveClosureNorthEastWithPiecesQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.transitiveClosureNorthEastWithPieces";
    }
      ...
      try {
      	{
      		...
      		new BinaryTransitiveClosure(body, new FlatTuple(var_start, var_square), NEQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern transitiveClosureNorthEastWithPieces";
      		                            }
