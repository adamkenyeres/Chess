...
/**
 * A pattern-specific query specification that can instantiate MovesEastMatcher in a type-safe way.
 * 
 * @see MovesEastMatcher
 * @see MovesEastMatch
 * 
 */
@SuppressWarnings("all")
public final class MovesEastQuerySpecification extends BaseGeneratedEMFQuerySpecification<MovesEastMatcher> {
  private MovesEastQuerySpecification() {
   ...
   * 
   */
  public static MovesEastQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  protected MovesEastMatcher instantiate(final ViatraQueryEngine engine) throws ViatraQueryException {
    return MovesEastMatcher.on(engine);
  }
  
  @Override
  public MovesEastMatch newEmptyMatch() {
    return MovesEastMatch.newEmptyMatch();
  }
  
  @Override
  public MovesEastMatch newMatch(final Object... parameters) {
    return MovesEastMatch.newMatch((chessdiagram.Square) parameters[0], (chessdiagram.Square) parameters[1], (chessdiagram.Square) parameters[2]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MovesEastQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link MovesEastQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static MovesEastQuerySpecification INSTANCE = new MovesEastQuerySpecification();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static MovesEastQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "chess.queries.movesEast";
    }
      ...
      try {
      	{
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                            ...
      		                            public String getShortDescription() {
      		                                return "Expression evaluation from pattern movesEast";
      		                            }
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	find hEast(squareStart, squareMiddle)
      		new PositivePatternCall(body, new FlatTuple(var_squareStart, var_squareMiddle), HEastQuerySpecification.instance().getInternalQueryRepresentation());
      		...
      		new ExpressionEvaluation(body, new IExpressionEvaluator() {
      		                        ...
      		                        },  null); // 	C == count find	transitiveClosureWestWithPieces(squareMiddle, squareStart, _)
      		PVariable var__virtual_3_ = body.getOrCreateVariableByName(".virtual{3}");
      		new PatternMatchCounter(body, new FlatTuple(var_squareMiddle, var_squareStart, var___0_), TransitiveClosureWestWithPiecesQuerySpecification.instance().getInternalQueryRepresentation(), var__virtual_3_);
