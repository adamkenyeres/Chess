...
public abstract class WhiteBishopMovesMatch extends BasePatternMatch {
  ...
  private WhiteBishopMovesMatch(final Bishop pPiece, final Square pSquare) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static WhiteBishopMovesMatch newMutableMatch(final Bishop pPiece, final Square pSquare) {
   ...
   * 
   */
  public static WhiteBishopMovesMatch newMatch(final Bishop pPiece, final Square pSquare) {
