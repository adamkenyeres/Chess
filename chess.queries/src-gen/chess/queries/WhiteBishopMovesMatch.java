...
/**
 * Pattern-specific match representation of the chess.queries.whiteBishopMoves pattern,
 * to be used in conjunction with {@link WhiteBishopMovesMatcher}.
 * 
...
public abstract class WhiteBishopMovesMatch extends BasePatternMatch {
  ...
  private WhiteBishopMovesMatch(final Bishop pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return WhiteBishopMovesMatch.parameterNames;
  }
  ...
  @Override
  public WhiteBishopMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WhiteBishopMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    WhiteBishopMovesMatch other = (WhiteBishopMovesMatch) obj;
  ...
  @Override
  public WhiteBishopMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WhiteBishopMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static WhiteBishopMovesMatch newMutableMatch(final Bishop pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static WhiteBishopMovesMatch newMatch(final Bishop pPiece, final Square pSquare, final Chess pChess) {
    return new Immutable(pPiece, pSquare, pChess);
  }
  
  private static final class Mutable extends WhiteBishopMovesMatch {
  ...
  private static final class Immutable extends WhiteBishopMovesMatch {
