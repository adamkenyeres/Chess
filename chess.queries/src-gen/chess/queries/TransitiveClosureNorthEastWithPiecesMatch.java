...
/**
 * Pattern-specific match representation of the chess.queries.transitiveClosureNorthEastWithPieces pattern,
 * to be used in conjunction with {@link TransitiveClosureNorthEastWithPiecesMatcher}.
 * 
...
public abstract class TransitiveClosureNorthEastWithPiecesMatch extends BasePatternMatch {
  ...
  private TransitiveClosureNorthEastWithPiecesMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    this.fStart = pStart;
    this.fEnd = pEnd;
  ...
  public List<String> parameterNames() {
    return TransitiveClosureNorthEastWithPiecesMatch.parameterNames;
  }
  ...
  @Override
  public TransitiveClosureNorthEastWithPiecesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitiveClosureNorthEastWithPiecesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TransitiveClosureNorthEastWithPiecesMatch other = (TransitiveClosureNorthEastWithPiecesMatch) obj;
  ...
  @Override
  public TransitiveClosureNorthEastWithPiecesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TransitiveClosureNorthEastWithPiecesMatch newEmptyMatch() {
   ...
   * 
   */
  public static TransitiveClosureNorthEastWithPiecesMatch newMutableMatch(final Square pStart, final Square pEnd, final Square pSquare) {
   ...
   * 
   */
  public static TransitiveClosureNorthEastWithPiecesMatch newMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    return new Immutable(pStart, pEnd, pSquare);
  }
  
  private static final class Mutable extends TransitiveClosureNorthEastWithPiecesMatch {
  ...
  private static final class Immutable extends TransitiveClosureNorthEastWithPiecesMatch {
