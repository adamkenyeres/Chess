...
/**
 * Pattern-specific match representation of the chess.queries.hEast pattern,
 * to be used in conjunction with {@link HEastMatcher}.
 * 
...
public abstract class HEastMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private HEastMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return HEastMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    HEastMatch other = (HEastMatch) obj;
  ...
  @Override
  public HEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static HEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static HEastMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static HEastMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends HEastMatch {
  ...
  private static final class Immutable extends HEastMatch {
