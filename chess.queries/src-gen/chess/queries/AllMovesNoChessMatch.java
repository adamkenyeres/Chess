...
/**
 * Pattern-specific match representation of the chess.queries.allMovesNoChess pattern,
 * to be used in conjunction with {@link AllMovesNoChessMatcher}.
 * 
...
public abstract class AllMovesNoChessMatch extends BasePatternMatch {
  ...
  private AllMovesNoChessMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return AllMovesNoChessMatch.parameterNames;
  }
  ...
  @Override
  public AllMovesNoChessMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AllMovesNoChessMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    AllMovesNoChessMatch other = (AllMovesNoChessMatch) obj;
  ...
  @Override
  public AllMovesNoChessQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static AllMovesNoChessMatch newEmptyMatch() {
   ...
   * 
   */
  public static AllMovesNoChessMatch newMutableMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static AllMovesNoChessMatch newMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    return new Immutable(pPiece, pSquare, pChess);
  }
  
  private static final class Mutable extends AllMovesNoChessMatch {
    Mutable(final Piece pPiece, final Square pSquare, final Chess pChess) {
  ...
  private static final class Immutable extends AllMovesNoChessMatch {
    Immutable(final Piece pPiece, final Square pSquare, final Chess pChess) {
      super(pPiece, pSquare, pChess);
    }
