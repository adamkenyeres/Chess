...
public abstract class AllMovesNoChessMatch extends BasePatternMatch {
  ...
  private AllMovesNoChessMatch(final Piece pPiece, final Square pSquare) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static AllMovesNoChessMatch newMutableMatch(final Piece pPiece, final Square pSquare) {
   ...
   * 
   */
  public static AllMovesNoChessMatch newMatch(final Piece pPiece, final Square pSquare) {
