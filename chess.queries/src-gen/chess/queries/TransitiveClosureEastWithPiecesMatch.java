...
/**
 * Pattern-specific match representation of the chess.queries.transitiveClosureEastWithPieces pattern,
 * to be used in conjunction with {@link TransitiveClosureEastWithPiecesMatcher}.
 * 
...
public abstract class TransitiveClosureEastWithPiecesMatch extends BasePatternMatch {
  ...
  private TransitiveClosureEastWithPiecesMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    this.fStart = pStart;
    this.fEnd = pEnd;
  ...
  public List<String> parameterNames() {
    return TransitiveClosureEastWithPiecesMatch.parameterNames;
  }
  ...
  @Override
  public TransitiveClosureEastWithPiecesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitiveClosureEastWithPiecesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TransitiveClosureEastWithPiecesMatch other = (TransitiveClosureEastWithPiecesMatch) obj;
  ...
  @Override
  public TransitiveClosureEastWithPiecesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TransitiveClosureEastWithPiecesMatch newEmptyMatch() {
   ...
   * 
   */
  public static TransitiveClosureEastWithPiecesMatch newMutableMatch(final Square pStart, final Square pEnd, final Square pSquare) {
   ...
   * 
   */
  public static TransitiveClosureEastWithPiecesMatch newMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    return new Immutable(pStart, pEnd, pSquare);
  }
  
  private static final class Mutable extends TransitiveClosureEastWithPiecesMatch {
  ...
  private static final class Immutable extends TransitiveClosureEastWithPiecesMatch {
