 ...
 * <p>Original source:
 * <code><pre>
 * pattern knightMoves(knight : Knight, square : Square){
...
public class KnightMovesMatcher extends BaseMatcher<KnightMovesMatch> {
   ...
   * 
   */
  public Collection<KnightMovesMatch> getAllMatches(final Knight pKnight, final Square pSquare) {
    return rawGetAllMatches(new Object[]{pKnight, pSquare});
  }
   ...
   * 
   */
  public KnightMovesMatch getOneArbitraryMatch(final Knight pKnight, final Square pSquare) {
    return rawGetOneArbitraryMatch(new Object[]{pKnight, pSquare});
  }
   ...
   * 
   */
  public boolean hasMatch(final Knight pKnight, final Square pSquare) {
    return rawHasMatch(new Object[]{pKnight, pSquare});
  }
   ...
   * 
   */
  public int countMatches(final Knight pKnight, final Square pSquare) {
    return rawCountMatches(new Object[]{pKnight, pSquare});
  }
   ...
   * 
   */
  public void forEachMatch(final Knight pKnight, final Square pSquare, final IMatchProcessor<? super KnightMovesMatch> processor) {
    rawForEachMatch(new Object[]{pKnight, pSquare}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Knight pKnight, final Square pSquare, final IMatchProcessor<? super KnightMovesMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pKnight, pSquare}, processor);
  }
   ...
   * 
   */
  public KnightMovesMatch newMatch(final Knight pKnight, final Square pSquare) {
    return KnightMovesMatch.newMatch(pKnight, pSquare);
  }
   ...
   * 
   */
  public Set<Knight> getAllValuesOfknight(final Square pSquare) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final Knight pKnight) {
  ...
  protected KnightMovesMatch tupleToMatch(final Tuple t) {
    try {
    	return KnightMovesMatch.newMatch((Knight) t.get(POSITION_KNIGHT), (Square) t.get(POSITION_SQUARE));
  ...
  protected KnightMovesMatch arrayToMatch(final Object[] match) {
    try {
    	return KnightMovesMatch.newMatch((Knight) match[POSITION_KNIGHT], (Square) match[POSITION_SQUARE]);
    } catch(ClassCastException e) {
  ...
  protected KnightMovesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return KnightMovesMatch.newMutableMatch((Knight) match[POSITION_KNIGHT], (Square) match[POSITION_SQUARE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
