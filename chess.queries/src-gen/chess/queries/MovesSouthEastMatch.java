...
/**
 * Pattern-specific match representation of the chess.queries.movesSouthEast pattern,
 * to be used in conjunction with {@link MovesSouthEastMatcher}.
 * 
...
public abstract class MovesSouthEastMatch extends BasePatternMatch {
  ...
  private MovesSouthEastMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
  ...
  public List<String> parameterNames() {
    return MovesSouthEastMatch.parameterNames;
  }
  ...
  @Override
  public MovesSouthEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MovesSouthEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MovesSouthEastMatch other = (MovesSouthEastMatch) obj;
  ...
  @Override
  public MovesSouthEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MovesSouthEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static MovesSouthEastMatch newMutableMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public static MovesSouthEastMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return new Immutable(pSquareStart, pSquareEnd, pSquareMiddle);
  }
  
  private static final class Mutable extends MovesSouthEastMatch {
  ...
  private static final class Immutable extends MovesSouthEastMatch {
