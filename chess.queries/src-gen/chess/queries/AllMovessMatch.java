...
public abstract class AllMovessMatch extends BasePatternMatch {
  ...
  private AllMovessMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static AllMovessMatch newMutableMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static AllMovessMatch newMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
