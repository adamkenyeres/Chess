...
/**
 * Pattern-specific match representation of the chess.queries.transitiveClosureSouthEastWithPieces pattern,
 * to be used in conjunction with {@link TransitiveClosureSouthEastWithPiecesMatcher}.
 * 
...
public abstract class TransitiveClosureSouthEastWithPiecesMatch extends BasePatternMatch {
  ...
  private TransitiveClosureSouthEastWithPiecesMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    this.fStart = pStart;
    this.fEnd = pEnd;
  ...
  public List<String> parameterNames() {
    return TransitiveClosureSouthEastWithPiecesMatch.parameterNames;
  }
  ...
  @Override
  public TransitiveClosureSouthEastWithPiecesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitiveClosureSouthEastWithPiecesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TransitiveClosureSouthEastWithPiecesMatch other = (TransitiveClosureSouthEastWithPiecesMatch) obj;
  ...
  @Override
  public TransitiveClosureSouthEastWithPiecesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TransitiveClosureSouthEastWithPiecesMatch newEmptyMatch() {
   ...
   * 
   */
  public static TransitiveClosureSouthEastWithPiecesMatch newMutableMatch(final Square pStart, final Square pEnd, final Square pSquare) {
   ...
   * 
   */
  public static TransitiveClosureSouthEastWithPiecesMatch newMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    return new Immutable(pStart, pEnd, pSquare);
  }
  
  private static final class Mutable extends TransitiveClosureSouthEastWithPiecesMatch {
  ...
  private static final class Immutable extends TransitiveClosureSouthEastWithPiecesMatch {
