...
import chess.queries.MovesNorthEastMatch;
...
/**
 * Generated pattern matcher API of the chess.queries.movesNorthEast pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link MovesNorthEastMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see MovesNorthEastMatch
 * @see MovesNorthEastProcessor
 * @see MovesNorthEastQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class MovesNorthEastMatcher extends BaseMatcher<MovesNorthEastMatch> {
  /**
   ...
   * 
   */
  public static MovesNorthEastMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    MovesNorthEastMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new MovesNorthEastMatcher(engine);
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MovesNorthEastMatcher.class);
   ...
   * 
   */
  private MovesNorthEastMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * @return matches represented as a MovesNorthEastMatch object.
   * 
   */
  public Collection<MovesNorthEastMatch> getAllMatches(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * @param pSquareEnd the fixed value of pattern parameter squareEnd, or null if not bound.
   * @param pSquareMiddle the fixed value of pattern parameter squareMiddle, or null if not bound.
   * @return a match represented as a MovesNorthEastMatch object, or null if no match is found.
   * 
   */
  public MovesNorthEastMatch getOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesNorthEastMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesNorthEastMatch> processor) {
   ...
   * 
   */
  public MovesNorthEastMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return MovesNorthEastMatch.newMatch(pSquareStart, pSquareEnd, pSquareMiddle);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareStart(final MovesNorthEastMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareEnd(final MovesNorthEastMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareMiddle(final MovesNorthEastMatch partialMatch) {
  ...
  @Override
  protected MovesNorthEastMatch tupleToMatch(final Tuple t) {
    try {
    	return MovesNorthEastMatch.newMatch((Square) t.get(POSITION_SQUARESTART), (Square) t.get(POSITION_SQUAREEND), (Square) t.get(POSITION_SQUAREMIDDLE));
  ...
  @Override
  protected MovesNorthEastMatch arrayToMatch(final Object[] match) {
    try {
    	return MovesNorthEastMatch.newMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected MovesNorthEastMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return MovesNorthEastMatch.newMutableMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<MovesNorthEastMatcher> querySpecification() throws ViatraQueryException {
