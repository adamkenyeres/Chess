...
/**
 * Pattern-specific match representation of the chess.queries.whitePlayerTurn pattern,
 * to be used in conjunction with {@link WhitePlayerTurnMatcher}.
 * 
...
public abstract class WhitePlayerTurnMatch extends BasePatternMatch {
  private Chess fChess;
  
  private static List<String> parameterNames = makeImmutableList("chess");
  
  private WhitePlayerTurnMatch(final Chess pChess) {
    this.fChess = pChess;
  }
  ...
  public List<String> parameterNames() {
    return WhitePlayerTurnMatch.parameterNames;
  }
  ...
  @Override
  public WhitePlayerTurnMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WhitePlayerTurnMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    WhitePlayerTurnMatch other = (WhitePlayerTurnMatch) obj;
  ...
  @Override
  public WhitePlayerTurnQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WhitePlayerTurnMatch newEmptyMatch() {
   ...
   * 
   */
  public static WhitePlayerTurnMatch newMutableMatch(final Chess pChess) {
   ...
   * 
   */
  public static WhitePlayerTurnMatch newMatch(final Chess pChess) {
    return new Immutable(pChess);
  }
  
  private static final class Mutable extends WhitePlayerTurnMatch {
  ...
  private static final class Immutable extends WhitePlayerTurnMatch {
