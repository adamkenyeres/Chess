...
public abstract class BlackPawnMovesMatch extends BasePatternMatch {
  ...
  private BlackPawnMovesMatch(final Pawn pPiece, final Square pSquare) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static BlackPawnMovesMatch newMutableMatch(final Pawn pPiece, final Square pSquare) {
   ...
   * 
   */
  public static BlackPawnMovesMatch newMatch(final Pawn pPiece, final Square pSquare) {
