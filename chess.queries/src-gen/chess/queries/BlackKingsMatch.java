...
/**
 * Pattern-specific match representation of the chess.queries.blackKings pattern,
 * to be used in conjunction with {@link BlackKingsMatcher}.
 * 
...
public abstract class BlackKingsMatch extends BasePatternMatch {
  private King fKing;
  
  private static List<String> parameterNames = makeImmutableList("king");
  
  private BlackKingsMatch(final King pKing) {
    this.fKing = pKing;
  }
  ...
  public List<String> parameterNames() {
    return BlackKingsMatch.parameterNames;
  }
  ...
  @Override
  public BlackKingsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BlackKingsMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BlackKingsMatch other = (BlackKingsMatch) obj;
  ...
  @Override
  public BlackKingsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BlackKingsMatch newEmptyMatch() {
   ...
   * 
   */
  public static BlackKingsMatch newMutableMatch(final King pKing) {
   ...
   * 
   */
  public static BlackKingsMatch newMatch(final King pKing) {
    return new Immutable(pKing);
  }
  
  private static final class Mutable extends BlackKingsMatch {
  ...
  private static final class Immutable extends BlackKingsMatch {
