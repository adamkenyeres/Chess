...
/**
 * Generated pattern matcher API of the chess.queries.SW pattern,
...
public class SWMatcher extends BaseMatcher<SWMatch> {
   ...
   * 
   */
  private SWMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
