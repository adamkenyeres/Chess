...
/**
 * Pattern-specific match representation of the chess.queries.blackKnights pattern,
 * to be used in conjunction with {@link BlackKnightsMatcher}.
 * 
...
public abstract class BlackKnightsMatch extends BasePatternMatch {
  private Knight fKnight;
  
  private static List<String> parameterNames = makeImmutableList("knight");
  
  private BlackKnightsMatch(final Knight pKnight) {
  ...
  public List<String> parameterNames() {
    return BlackKnightsMatch.parameterNames;
  }
  ...
  @Override
  public BlackKnightsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BlackKnightsMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BlackKnightsMatch other = (BlackKnightsMatch) obj;
  ...
  @Override
  public BlackKnightsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BlackKnightsMatch newEmptyMatch() {
   ...
   * 
   */
  public static BlackKnightsMatch newMutableMatch(final Knight pKnight) {
   ...
   * 
   */
  public static BlackKnightsMatch newMatch(final Knight pKnight) {
    return new Immutable(pKnight);
  }
  
  private static final class Mutable extends BlackKnightsMatch {
  ...
  private static final class Immutable extends BlackKnightsMatch {
