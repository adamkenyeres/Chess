...
/**
 * Generated pattern matcher API of the chess.queries.blackRookMoves pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link BlackRookMovesMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see BlackRookMovesQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class BlackRookMovesMatcher extends BaseMatcher<BlackRookMovesMatch> {
  /**
   ...
   * 
   */
  public static BlackRookMovesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    BlackRookMovesMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new BlackRookMovesMatcher(engine);
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BlackRookMovesMatcher.class);
   ...
   * 
   */
  private BlackRookMovesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * @return matches represented as a BlackRookMovesMatch object.
   * 
   */
  public Collection<BlackRookMovesMatch> getAllMatches(final Rook pRook, final Square pSquare, final Chess pChess) {
   ...
   * @param pSquare the fixed value of pattern parameter square, or null if not bound.
   * @param pChess the fixed value of pattern parameter chess, or null if not bound.
   * @return a match represented as a BlackRookMovesMatch object, or null if no match is found.
   * 
   */
  public BlackRookMovesMatch getOneArbitraryMatch(final Rook pRook, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public void forEachMatch(final Rook pRook, final Square pSquare, final Chess pChess, final IMatchProcessor<? super BlackRookMovesMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Rook pRook, final Square pSquare, final Chess pChess, final IMatchProcessor<? super BlackRookMovesMatch> processor) {
   ...
   * 
   */
  public BlackRookMovesMatch newMatch(final Rook pRook, final Square pSquare, final Chess pChess) {
    return BlackRookMovesMatch.newMatch(pRook, pSquare, pChess);
  }
   ...
   * 
   */
  public Set<Rook> getAllValuesOfrook(final BlackRookMovesMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final BlackRookMovesMatch partialMatch) {
   ...
   * 
   */
  public Set<Chess> getAllValuesOfchess(final BlackRookMovesMatch partialMatch) {
  ...
  @Override
  protected BlackRookMovesMatch tupleToMatch(final Tuple t) {
    try {
    	return BlackRookMovesMatch.newMatch((Rook) t.get(POSITION_ROOK), (Square) t.get(POSITION_SQUARE), (Chess) t.get(POSITION_CHESS));
  ...
  @Override
  protected BlackRookMovesMatch arrayToMatch(final Object[] match) {
    try {
    	return BlackRookMovesMatch.newMatch((Rook) match[POSITION_ROOK], (Square) match[POSITION_SQUARE], (Chess) match[POSITION_CHESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected BlackRookMovesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return BlackRookMovesMatch.newMutableMatch((Rook) match[POSITION_ROOK], (Square) match[POSITION_SQUARE], (Chess) match[POSITION_CHESS]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<BlackRookMovesMatcher> querySpecification() throws ViatraQueryException {
