...
/**
 * Pattern-specific match representation of the chess.queries.transitiveClosureSouthWithPieces pattern,
 * to be used in conjunction with {@link TransitiveClosureSouthWithPiecesMatcher}.
 * 
...
public abstract class TransitiveClosureSouthWithPiecesMatch extends BasePatternMatch {
  ...
  private TransitiveClosureSouthWithPiecesMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    this.fStart = pStart;
    this.fEnd = pEnd;
  ...
  public List<String> parameterNames() {
    return TransitiveClosureSouthWithPiecesMatch.parameterNames;
  }
  ...
  @Override
  public TransitiveClosureSouthWithPiecesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitiveClosureSouthWithPiecesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TransitiveClosureSouthWithPiecesMatch other = (TransitiveClosureSouthWithPiecesMatch) obj;
  ...
  @Override
  public TransitiveClosureSouthWithPiecesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TransitiveClosureSouthWithPiecesMatch newEmptyMatch() {
   ...
   * 
   */
  public static TransitiveClosureSouthWithPiecesMatch newMutableMatch(final Square pStart, final Square pEnd, final Square pSquare) {
   ...
   * 
   */
  public static TransitiveClosureSouthWithPiecesMatch newMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    return new Immutable(pStart, pEnd, pSquare);
  }
  
  private static final class Mutable extends TransitiveClosureSouthWithPiecesMatch {
  ...
  private static final class Immutable extends TransitiveClosureSouthWithPiecesMatch {
