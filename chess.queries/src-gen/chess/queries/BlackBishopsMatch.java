...
/**
 * Pattern-specific match representation of the chess.queries.blackBishops pattern,
 * to be used in conjunction with {@link BlackBishopsMatcher}.
 * 
...
public abstract class BlackBishopsMatch extends BasePatternMatch {
  private Bishop fBishop;
  
  private static List<String> parameterNames = makeImmutableList("bishop");
  
  private BlackBishopsMatch(final Bishop pBishop) {
  ...
  public List<String> parameterNames() {
    return BlackBishopsMatch.parameterNames;
  }
  ...
  @Override
  public BlackBishopsMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BlackBishopsMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BlackBishopsMatch other = (BlackBishopsMatch) obj;
  ...
  @Override
  public BlackBishopsQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BlackBishopsMatch newEmptyMatch() {
   ...
   * 
   */
  public static BlackBishopsMatch newMutableMatch(final Bishop pBishop) {
   ...
   * 
   */
  public static BlackBishopsMatch newMatch(final Bishop pBishop) {
    return new Immutable(pBishop);
  }
  
  private static final class Mutable extends BlackBishopsMatch {
  ...
  private static final class Immutable extends BlackBishopsMatch {
