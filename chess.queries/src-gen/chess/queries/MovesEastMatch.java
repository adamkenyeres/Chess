...
/**
 * Pattern-specific match representation of the chess.queries.movesEast pattern,
 * to be used in conjunction with {@link MovesEastMatcher}.
 * 
...
public abstract class MovesEastMatch extends BasePatternMatch {
  ...
  private MovesEastMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
  ...
  public List<String> parameterNames() {
    return MovesEastMatch.parameterNames;
  }
  ...
  @Override
  public MovesEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MovesEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MovesEastMatch other = (MovesEastMatch) obj;
  ...
  @Override
  public MovesEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MovesEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static MovesEastMatch newMutableMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public static MovesEastMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return new Immutable(pSquareStart, pSquareEnd, pSquareMiddle);
  }
  
  private static final class Mutable extends MovesEastMatch {
  ...
  private static final class Immutable extends MovesEastMatch {
