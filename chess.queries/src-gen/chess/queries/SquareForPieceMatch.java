...
/**
 * Pattern-specific match representation of the chess.queries.squareForPiece pattern,
 * to be used in conjunction with {@link SquareForPieceMatcher}.
 * 
...
public abstract class SquareForPieceMatch extends BasePatternMatch {
  ...
  private SquareForPieceMatch(final Piece pPiece, final Square pSquare) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return SquareForPieceMatch.parameterNames;
  }
  ...
  @Override
  public SquareForPieceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SquareForPieceMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SquareForPieceMatch other = (SquareForPieceMatch) obj;
  ...
  @Override
  public SquareForPieceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SquareForPieceMatch newEmptyMatch() {
   ...
   * 
   */
  public static SquareForPieceMatch newMutableMatch(final Piece pPiece, final Square pSquare) {
   ...
   * 
   */
  public static SquareForPieceMatch newMatch(final Piece pPiece, final Square pSquare) {
    return new Immutable(pPiece, pSquare);
  }
  
  private static final class Mutable extends SquareForPieceMatch {
  ...
  private static final class Immutable extends SquareForPieceMatch {
