...
import chess.queries.MovesNorthMatch;
...
/**
 * Generated pattern matcher API of the chess.queries.movesNorth pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link MovesNorthMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * 
 * @see MovesNorthMatch
 * @see MovesNorthProcessor
 * @see MovesNorthQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class MovesNorthMatcher extends BaseMatcher<MovesNorthMatch> {
  /**
   ...
   * 
   */
  public static MovesNorthMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    MovesNorthMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new MovesNorthMatcher(engine);
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MovesNorthMatcher.class);
   ...
   * 
   */
  private MovesNorthMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * @return matches represented as a MovesNorthMatch object.
   * 
   */
  public Collection<MovesNorthMatch> getAllMatches(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * @param pSquareEnd the fixed value of pattern parameter squareEnd, or null if not bound.
   * @param pSquareMiddle the fixed value of pattern parameter squareMiddle, or null if not bound.
   * @return a match represented as a MovesNorthMatch object, or null if no match is found.
   * 
   */
  public MovesNorthMatch getOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesNorthMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesNorthMatch> processor) {
   ...
   * 
   */
  public MovesNorthMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return MovesNorthMatch.newMatch(pSquareStart, pSquareEnd, pSquareMiddle);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareStart(final MovesNorthMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareEnd(final MovesNorthMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareMiddle(final MovesNorthMatch partialMatch) {
  ...
  @Override
  protected MovesNorthMatch tupleToMatch(final Tuple t) {
    try {
    	return MovesNorthMatch.newMatch((Square) t.get(POSITION_SQUARESTART), (Square) t.get(POSITION_SQUAREEND), (Square) t.get(POSITION_SQUAREMIDDLE));
  ...
  @Override
  protected MovesNorthMatch arrayToMatch(final Object[] match) {
    try {
    	return MovesNorthMatch.newMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected MovesNorthMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return MovesNorthMatch.newMutableMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<MovesNorthMatcher> querySpecification() throws ViatraQueryException {
