...
/**
 * Generated pattern matcher API of the chess.queries.movesNorthWest pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link MovesNorthWestMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * </pre></code>
 * 
 * @see MovesNorthWestMatch
 * @see MovesNorthWestProcessor
 * @see MovesNorthWestQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class MovesNorthWestMatcher extends BaseMatcher<MovesNorthWestMatch> {
  /**
   ...
   * 
   */
  public static MovesNorthWestMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    MovesNorthWestMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new MovesNorthWestMatcher(engine);
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MovesNorthWestMatcher.class);
   ...
   * 
   */
  private MovesNorthWestMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * @return matches represented as a MovesNorthWestMatch object.
   * 
   */
  public Collection<MovesNorthWestMatch> getAllMatches(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * @param pSquareEnd the fixed value of pattern parameter squareEnd, or null if not bound.
   * @param pSquareMiddle the fixed value of pattern parameter squareMiddle, or null if not bound.
   * @return a match represented as a MovesNorthWestMatch object, or null if no match is found.
   * 
   */
  public MovesNorthWestMatch getOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesNorthWestMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesNorthWestMatch> processor) {
   ...
   * 
   */
  public MovesNorthWestMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return MovesNorthWestMatch.newMatch(pSquareStart, pSquareEnd, pSquareMiddle);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareStart(final MovesNorthWestMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareEnd(final MovesNorthWestMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareMiddle(final MovesNorthWestMatch partialMatch) {
  ...
  @Override
  protected MovesNorthWestMatch tupleToMatch(final Tuple t) {
    try {
    	return MovesNorthWestMatch.newMatch((Square) t.get(POSITION_SQUARESTART), (Square) t.get(POSITION_SQUAREEND), (Square) t.get(POSITION_SQUAREMIDDLE));
  ...
  @Override
  protected MovesNorthWestMatch arrayToMatch(final Object[] match) {
    try {
    	return MovesNorthWestMatch.newMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected MovesNorthWestMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return MovesNorthWestMatch.newMutableMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<MovesNorthWestMatcher> querySpecification() throws ViatraQueryException {
