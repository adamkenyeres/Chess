...
/**
 * Pattern-specific match representation of the chess.queries.transitiveClosureWestWithPieces pattern,
 * to be used in conjunction with {@link TransitiveClosureWestWithPiecesMatcher}.
 * 
...
public abstract class TransitiveClosureWestWithPiecesMatch extends BasePatternMatch {
  ...
  private TransitiveClosureWestWithPiecesMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    this.fStart = pStart;
    this.fEnd = pEnd;
  ...
  public List<String> parameterNames() {
    return TransitiveClosureWestWithPiecesMatch.parameterNames;
  }
  ...
  @Override
  public TransitiveClosureWestWithPiecesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitiveClosureWestWithPiecesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TransitiveClosureWestWithPiecesMatch other = (TransitiveClosureWestWithPiecesMatch) obj;
  ...
  @Override
  public TransitiveClosureWestWithPiecesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TransitiveClosureWestWithPiecesMatch newEmptyMatch() {
   ...
   * 
   */
  public static TransitiveClosureWestWithPiecesMatch newMutableMatch(final Square pStart, final Square pEnd, final Square pSquare) {
   ...
   * 
   */
  public static TransitiveClosureWestWithPiecesMatch newMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    return new Immutable(pStart, pEnd, pSquare);
  }
  
  private static final class Mutable extends TransitiveClosureWestWithPiecesMatch {
  ...
  private static final class Immutable extends TransitiveClosureWestWithPiecesMatch {
