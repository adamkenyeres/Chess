...
/**
 * Pattern-specific match representation of the chess.queries.blackKnightMoves pattern,
 * to be used in conjunction with {@link BlackKnightMovesMatcher}.
 * 
...
public abstract class BlackKnightMovesMatch extends BasePatternMatch {
  ...
  public List<String> parameterNames() {
    return BlackKnightMovesMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BlackKnightMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BlackKnightMovesMatch other = (BlackKnightMovesMatch) obj;
  ...
  @Override
  public BlackKnightMovesQuerySpecification specification() {
    try {
