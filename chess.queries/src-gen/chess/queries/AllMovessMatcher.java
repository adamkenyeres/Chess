...
public class AllMovessMatcher extends BaseMatcher<AllMovessMatch> {
   ...
   * 
   */
  public Collection<AllMovessMatch> getAllMatches(final Piece pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public AllMovessMatch getOneArbitraryMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public void forEachMatch(final Piece pPiece, final Square pSquare, final Chess pChess, final IMatchProcessor<? super AllMovessMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Piece pPiece, final Square pSquare, final Chess pChess, final IMatchProcessor<? super AllMovessMatch> processor) {
   ...
   * 
   */
  public AllMovessMatch newMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    return AllMovessMatch.newMatch(pPiece, pSquare, pChess);
  }
   ...
   * 
   */
  public Set<Chess> getAllValuesOfchess(final AllMovessMatch partialMatch) {
  ...
  protected AllMovessMatch tupleToMatch(final Tuple t) {
    try {
    	return AllMovessMatch.newMatch((Piece) t.get(POSITION_PIECE), (Square) t.get(POSITION_SQUARE), (Chess) t.get(POSITION_CHESS));
  ...
  protected AllMovessMatch arrayToMatch(final Object[] match) {
    try {
    	return AllMovessMatch.newMatch((Piece) match[POSITION_PIECE], (Square) match[POSITION_SQUARE], (Chess) match[POSITION_CHESS]);
    } catch(ClassCastException e) {
  ...
  protected AllMovessMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return AllMovessMatch.newMutableMatch((Piece) match[POSITION_PIECE], (Square) match[POSITION_SQUARE], (Chess) match[POSITION_CHESS]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
