...
/**
 * Pattern-specific match representation of the chess.queries.diagonalMoves pattern,
 * to be used in conjunction with {@link DiagonalMovesMatcher}.
 * 
...
public abstract class DiagonalMovesMatch extends BasePatternMatch {
  ...
  private DiagonalMovesMatch(final Piece pPiece, final Square pSquare) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return DiagonalMovesMatch.parameterNames;
  }
  ...
  @Override
  public DiagonalMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof DiagonalMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    DiagonalMovesMatch other = (DiagonalMovesMatch) obj;
  ...
  @Override
  public DiagonalMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DiagonalMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static DiagonalMovesMatch newMutableMatch(final Piece pPiece, final Square pSquare) {
   ...
   * 
   */
  public static DiagonalMovesMatch newMatch(final Piece pPiece, final Square pSquare) {
    return new Immutable(pPiece, pSquare);
  }
  
  private static final class Mutable extends DiagonalMovesMatch {
  ...
  private static final class Immutable extends DiagonalMovesMatch {
