...
/**
 * Generated pattern matcher API of the chess.queries.blackKingMoves pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link BlackKingMovesMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see BlackKingMovesProcessor
 * @see BlackKingMovesQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class BlackKingMovesMatcher extends BaseMatcher<BlackKingMovesMatch> {
  /**
   ...
   * 
   */
  public static BlackKingMovesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    BlackKingMovesMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new BlackKingMovesMatcher(engine);
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BlackKingMovesMatcher.class);
   ...
   * 
   */
  private BlackKingMovesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * @return matches represented as a BlackKingMovesMatch object.
   * 
   */
  public Collection<BlackKingMovesMatch> getAllMatches(final King pKing, final Square pSquare, final Chess pChess) {
   ...
   * @param pSquare the fixed value of pattern parameter square, or null if not bound.
   * @param pChess the fixed value of pattern parameter chess, or null if not bound.
   * @return a match represented as a BlackKingMovesMatch object, or null if no match is found.
   * 
   */
  public BlackKingMovesMatch getOneArbitraryMatch(final King pKing, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public void forEachMatch(final King pKing, final Square pSquare, final Chess pChess, final IMatchProcessor<? super BlackKingMovesMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final King pKing, final Square pSquare, final Chess pChess, final IMatchProcessor<? super BlackKingMovesMatch> processor) {
   ...
   * 
   */
  public BlackKingMovesMatch newMatch(final King pKing, final Square pSquare, final Chess pChess) {
    return BlackKingMovesMatch.newMatch(pKing, pSquare, pChess);
  }
   ...
   * 
   */
  public Set<King> getAllValuesOfking(final BlackKingMovesMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquare(final BlackKingMovesMatch partialMatch) {
   ...
   * 
   */
  public Set<Chess> getAllValuesOfchess(final BlackKingMovesMatch partialMatch) {
  ...
  @Override
  protected BlackKingMovesMatch tupleToMatch(final Tuple t) {
    try {
    	return BlackKingMovesMatch.newMatch((King) t.get(POSITION_KING), (Square) t.get(POSITION_SQUARE), (Chess) t.get(POSITION_CHESS));
  ...
  @Override
  protected BlackKingMovesMatch arrayToMatch(final Object[] match) {
    try {
    	return BlackKingMovesMatch.newMatch((King) match[POSITION_KING], (Square) match[POSITION_SQUARE], (Chess) match[POSITION_CHESS]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected BlackKingMovesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return BlackKingMovesMatch.newMutableMatch((King) match[POSITION_KING], (Square) match[POSITION_SQUARE], (Chess) match[POSITION_CHESS]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<BlackKingMovesMatcher> querySpecification() throws ViatraQueryException {
