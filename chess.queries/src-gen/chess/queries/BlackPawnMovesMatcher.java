...
public class BlackPawnMovesMatcher extends BaseMatcher<BlackPawnMovesMatch> {
   ...
   * 
   */
  public Collection<BlackPawnMovesMatch> getAllMatches(final Pawn pPiece, final Square pSquare) {
   ...
   * 
   */
  public BlackPawnMovesMatch getOneArbitraryMatch(final Pawn pPiece, final Square pSquare) {
   ...
   * 
   */
  public void forEachMatch(final Pawn pPiece, final Square pSquare, final IMatchProcessor<? super BlackPawnMovesMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Pawn pPiece, final Square pSquare, final IMatchProcessor<? super BlackPawnMovesMatch> processor) {
   ...
   * 
   */
  public BlackPawnMovesMatch newMatch(final Pawn pPiece, final Square pSquare) {
    return BlackPawnMovesMatch.newMatch(pPiece, pSquare);
  }
  ...
  protected BlackPawnMovesMatch tupleToMatch(final Tuple t) {
    try {
    	return BlackPawnMovesMatch.newMatch((Pawn) t.get(POSITION_PIECE), (Square) t.get(POSITION_SQUARE));
  ...
  protected BlackPawnMovesMatch arrayToMatch(final Object[] match) {
    try {
    	return BlackPawnMovesMatch.newMatch((Pawn) match[POSITION_PIECE], (Square) match[POSITION_SQUARE]);
    } catch(ClassCastException e) {
  ...
  protected BlackPawnMovesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return BlackPawnMovesMatch.newMutableMatch((Pawn) match[POSITION_PIECE], (Square) match[POSITION_SQUARE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
