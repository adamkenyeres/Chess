...
/**
 * Pattern-specific match representation of the chess.queries.blackPlayerTurn pattern,
 * to be used in conjunction with {@link BlackPlayerTurnMatcher}.
 * 
...
public abstract class BlackPlayerTurnMatch extends BasePatternMatch {
  private Chess fChess;
  
  private static List<String> parameterNames = makeImmutableList("chess");
  
  private BlackPlayerTurnMatch(final Chess pChess) {
    this.fChess = pChess;
  }
  ...
  public List<String> parameterNames() {
    return BlackPlayerTurnMatch.parameterNames;
  }
  ...
  @Override
  public BlackPlayerTurnMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BlackPlayerTurnMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BlackPlayerTurnMatch other = (BlackPlayerTurnMatch) obj;
  ...
  @Override
  public BlackPlayerTurnQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BlackPlayerTurnMatch newEmptyMatch() {
   ...
   * 
   */
  public static BlackPlayerTurnMatch newMutableMatch(final Chess pChess) {
   ...
   * 
   */
  public static BlackPlayerTurnMatch newMatch(final Chess pChess) {
    return new Immutable(pChess);
  }
  
  private static final class Mutable extends BlackPlayerTurnMatch {
  ...
  private static final class Immutable extends BlackPlayerTurnMatch {
