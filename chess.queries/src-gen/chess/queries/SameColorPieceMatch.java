...
/**
 * Pattern-specific match representation of the chess.queries.sameColorPiece pattern,
 * to be used in conjunction with {@link SameColorPieceMatcher}.
 * 
...
public abstract class SameColorPieceMatch extends BasePatternMatch {
  ...
  private SameColorPieceMatch(final Piece pPiece1, final Piece pPiece2) {
  ...
  public List<String> parameterNames() {
    return SameColorPieceMatch.parameterNames;
  }
  ...
  @Override
  public SameColorPieceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SameColorPieceMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SameColorPieceMatch other = (SameColorPieceMatch) obj;
  ...
  @Override
  public SameColorPieceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SameColorPieceMatch newEmptyMatch() {
   ...
   * 
   */
  public static SameColorPieceMatch newMutableMatch(final Piece pPiece1, final Piece pPiece2) {
   ...
   * 
   */
  public static SameColorPieceMatch newMatch(final Piece pPiece1, final Piece pPiece2) {
    return new Immutable(pPiece1, pPiece2);
  }
  
  private static final class Mutable extends SameColorPieceMatch {
  ...
  private static final class Immutable extends SameColorPieceMatch {
