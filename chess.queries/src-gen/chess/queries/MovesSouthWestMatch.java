...
/**
 * Pattern-specific match representation of the chess.queries.movesSouthWest pattern,
 * to be used in conjunction with {@link MovesSouthWestMatcher}.
 * 
...
public abstract class MovesSouthWestMatch extends BasePatternMatch {
  ...
  private MovesSouthWestMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
  ...
  public List<String> parameterNames() {
    return MovesSouthWestMatch.parameterNames;
  }
  ...
  @Override
  public MovesSouthWestMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MovesSouthWestMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MovesSouthWestMatch other = (MovesSouthWestMatch) obj;
  ...
  @Override
  public MovesSouthWestQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MovesSouthWestMatch newEmptyMatch() {
   ...
   * 
   */
  public static MovesSouthWestMatch newMutableMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public static MovesSouthWestMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return new Immutable(pSquareStart, pSquareEnd, pSquareMiddle);
  }
  
  private static final class Mutable extends MovesSouthWestMatch {
  ...
  private static final class Immutable extends MovesSouthWestMatch {
