...
/**
 * Pattern-specific match representation of the chess.queries.inChess pattern,
 * to be used in conjunction with {@link InChessMatcher}.
 * 
...
public abstract class InChessMatch extends BasePatternMatch {
  private King fKing;
  ...
  public List<String> parameterNames() {
    return InChessMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof InChessMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    InChessMatch other = (InChessMatch) obj;
  ...
  @Override
  public InChessQuerySpecification specification() {
    try {
