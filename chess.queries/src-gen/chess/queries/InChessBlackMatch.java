...
/**
 * Pattern-specific match representation of the chess.queries.inChessBlack pattern,
 * to be used in conjunction with {@link InChessBlackMatcher}.
 * 
...
public abstract class InChessBlackMatch extends BasePatternMatch {
  private King fKing;
  ...
  private InChessBlackMatch(final King pKing, final Piece pPiece, final Chess pChess) {
    this.fKing = pKing;
    this.fPiece = pPiece;
    this.fChess = pChess;
  }
  ...
  public List<String> parameterNames() {
    return InChessBlackMatch.parameterNames;
  }
  ...
  @Override
  public InChessBlackMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof InChessBlackMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    InChessBlackMatch other = (InChessBlackMatch) obj;
  ...
  @Override
  public InChessBlackQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static InChessBlackMatch newEmptyMatch() {
   ...
   * 
   */
  public static InChessBlackMatch newMutableMatch(final King pKing, final Piece pPiece, final Chess pChess) {
   ...
   * 
   */
  public static InChessBlackMatch newMatch(final King pKing, final Piece pPiece, final Chess pChess) {
    return new Immutable(pKing, pPiece, pChess);
  }
  
  private static final class Mutable extends InChessBlackMatch {
  ...
  private static final class Immutable extends InChessBlackMatch {
