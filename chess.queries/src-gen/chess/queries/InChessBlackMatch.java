...
public abstract class InChessBlackMatch extends BasePatternMatch {
  ...
  private InChessBlackMatch(final King pKing, final Piece pPiece) {
    this.fKing = pKing;
    this.fPiece = pPiece;
  }
   ...
   * 
   */
  public static InChessBlackMatch newMutableMatch(final King pKing, final Piece pPiece) {
   ...
   * 
   */
  public static InChessBlackMatch newMatch(final King pKing, final Piece pPiece) {
