...
/**
 * Pattern-specific match representation of the chess.queries.transitiveClosureSouthWestWithPieces pattern,
 * to be used in conjunction with {@link TransitiveClosureSouthWestWithPiecesMatcher}.
 * 
...
public abstract class TransitiveClosureSouthWestWithPiecesMatch extends BasePatternMatch {
  ...
  private TransitiveClosureSouthWestWithPiecesMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    this.fStart = pStart;
    this.fEnd = pEnd;
  ...
  public List<String> parameterNames() {
    return TransitiveClosureSouthWestWithPiecesMatch.parameterNames;
  }
  ...
  @Override
  public TransitiveClosureSouthWestWithPiecesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitiveClosureSouthWestWithPiecesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TransitiveClosureSouthWestWithPiecesMatch other = (TransitiveClosureSouthWestWithPiecesMatch) obj;
  ...
  @Override
  public TransitiveClosureSouthWestWithPiecesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TransitiveClosureSouthWestWithPiecesMatch newEmptyMatch() {
   ...
   * 
   */
  public static TransitiveClosureSouthWestWithPiecesMatch newMutableMatch(final Square pStart, final Square pEnd, final Square pSquare) {
   ...
   * 
   */
  public static TransitiveClosureSouthWestWithPiecesMatch newMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    return new Immutable(pStart, pEnd, pSquare);
  }
  
  private static final class Mutable extends TransitiveClosureSouthWestWithPiecesMatch {
  ...
  private static final class Immutable extends TransitiveClosureSouthWestWithPiecesMatch {
