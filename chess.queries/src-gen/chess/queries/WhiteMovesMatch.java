...
/**
 * Pattern-specific match representation of the chess.queries.whiteMoves pattern,
 * to be used in conjunction with {@link WhiteMovesMatcher}.
 * 
...
public abstract class WhiteMovesMatch extends BasePatternMatch {
  ...
  private WhiteMovesMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return WhiteMovesMatch.parameterNames;
  }
  ...
  @Override
  public WhiteMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WhiteMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    WhiteMovesMatch other = (WhiteMovesMatch) obj;
  ...
  @Override
  public WhiteMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WhiteMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static WhiteMovesMatch newMutableMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static WhiteMovesMatch newMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    return new Immutable(pPiece, pSquare, pChess);
  }
  
  private static final class Mutable extends WhiteMovesMatch {
  ...
  private static final class Immutable extends WhiteMovesMatch {
