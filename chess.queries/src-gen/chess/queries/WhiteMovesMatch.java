...
public abstract class WhiteMovesMatch extends BasePatternMatch {
  ...
  private WhiteMovesMatch(final Piece pPiece, final Square pSquare) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static WhiteMovesMatch newMutableMatch(final Piece pPiece, final Square pSquare) {
   ...
   * 
   */
  public static WhiteMovesMatch newMatch(final Piece pPiece, final Square pSquare) {
