...
/**
 * Pattern-specific match representation of the chess.queries.northDiagonalMoves pattern,
 * to be used in conjunction with {@link NorthDiagonalMovesMatcher}.
 * 
...
public abstract class NorthDiagonalMovesMatch extends BasePatternMatch {
  ...
  private NorthDiagonalMovesMatch(final Piece pBishop, final Square pSquare) {
  ...
  public List<String> parameterNames() {
    return NorthDiagonalMovesMatch.parameterNames;
  }
  ...
  @Override
  public NorthDiagonalMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NorthDiagonalMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NorthDiagonalMovesMatch other = (NorthDiagonalMovesMatch) obj;
  ...
  @Override
  public NorthDiagonalMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static NorthDiagonalMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static NorthDiagonalMovesMatch newMutableMatch(final Piece pBishop, final Square pSquare) {
   ...
   * 
   */
  public static NorthDiagonalMovesMatch newMatch(final Piece pBishop, final Square pSquare) {
    return new Immutable(pBishop, pSquare);
  }
  
  private static final class Mutable extends NorthDiagonalMovesMatch {
  ...
  private static final class Immutable extends NorthDiagonalMovesMatch {
