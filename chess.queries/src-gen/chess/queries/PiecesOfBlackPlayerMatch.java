...
/**
 * Pattern-specific match representation of the chess.queries.piecesOfBlackPlayer pattern,
 * to be used in conjunction with {@link PiecesOfBlackPlayerMatcher}.
 * 
...
public abstract class PiecesOfBlackPlayerMatch extends BasePatternMatch {
  private Piece fPiece;
  
  private static List<String> parameterNames = makeImmutableList("piece");
  
  private PiecesOfBlackPlayerMatch(final Piece pPiece) {
    this.fPiece = pPiece;
  }
  ...
  public List<String> parameterNames() {
    return PiecesOfBlackPlayerMatch.parameterNames;
  }
  ...
  @Override
  public PiecesOfBlackPlayerMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PiecesOfBlackPlayerMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PiecesOfBlackPlayerMatch other = (PiecesOfBlackPlayerMatch) obj;
  ...
  @Override
  public PiecesOfBlackPlayerQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PiecesOfBlackPlayerMatch newEmptyMatch() {
   ...
   * 
   */
  public static PiecesOfBlackPlayerMatch newMutableMatch(final Piece pPiece) {
   ...
   * 
   */
  public static PiecesOfBlackPlayerMatch newMatch(final Piece pPiece) {
    return new Immutable(pPiece);
  }
  
  private static final class Mutable extends PiecesOfBlackPlayerMatch {
  ...
  private static final class Immutable extends PiecesOfBlackPlayerMatch {
