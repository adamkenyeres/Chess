...
/**
 * Pattern-specific match representation of the chess.queries.hWest pattern,
 * to be used in conjunction with {@link HWestMatcher}.
 * 
...
public abstract class HWestMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private HWestMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return HWestMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HWestMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    HWestMatch other = (HWestMatch) obj;
  ...
  @Override
  public HWestQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static HWestMatch newEmptyMatch() {
   ...
   * 
   */
  public static HWestMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static HWestMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends HWestMatch {
  ...
  private static final class Immutable extends HWestMatch {
