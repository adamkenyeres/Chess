...
/**
 * Pattern-specific match representation of the chess.queries.transitiveClosureNorthWestWithPieces pattern,
 * to be used in conjunction with {@link TransitiveClosureNorthWestWithPiecesMatcher}.
 * 
...
public abstract class TransitiveClosureNorthWestWithPiecesMatch extends BasePatternMatch {
  ...
  private TransitiveClosureNorthWestWithPiecesMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    this.fStart = pStart;
    this.fEnd = pEnd;
  ...
  public List<String> parameterNames() {
    return TransitiveClosureNorthWestWithPiecesMatch.parameterNames;
  }
  ...
  @Override
  public TransitiveClosureNorthWestWithPiecesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TransitiveClosureNorthWestWithPiecesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TransitiveClosureNorthWestWithPiecesMatch other = (TransitiveClosureNorthWestWithPiecesMatch) obj;
  ...
  @Override
  public TransitiveClosureNorthWestWithPiecesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TransitiveClosureNorthWestWithPiecesMatch newEmptyMatch() {
   ...
   * 
   */
  public static TransitiveClosureNorthWestWithPiecesMatch newMutableMatch(final Square pStart, final Square pEnd, final Square pSquare) {
   ...
   * 
   */
  public static TransitiveClosureNorthWestWithPiecesMatch newMatch(final Square pStart, final Square pEnd, final Square pSquare) {
    return new Immutable(pStart, pEnd, pSquare);
  }
  
  private static final class Mutable extends TransitiveClosureNorthWestWithPiecesMatch {
  ...
  private static final class Immutable extends TransitiveClosureNorthWestWithPiecesMatch {
