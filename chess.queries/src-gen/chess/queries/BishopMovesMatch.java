...
public abstract class BishopMovesMatch extends BasePatternMatch {
  ...
  private BishopMovesMatch(final Bishop pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static BishopMovesMatch newMutableMatch(final Bishop pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static BishopMovesMatch newMatch(final Bishop pPiece, final Square pSquare, final Chess pChess) {
