...
/**
 * Pattern-specific match representation of the chess.queries.movesNorthWest pattern,
 * to be used in conjunction with {@link MovesNorthWestMatcher}.
 * 
...
public abstract class MovesNorthWestMatch extends BasePatternMatch {
  ...
  private MovesNorthWestMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
  ...
  public List<String> parameterNames() {
    return MovesNorthWestMatch.parameterNames;
  }
  ...
  @Override
  public MovesNorthWestMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MovesNorthWestMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MovesNorthWestMatch other = (MovesNorthWestMatch) obj;
  ...
  @Override
  public MovesNorthWestQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MovesNorthWestMatch newEmptyMatch() {
   ...
   * 
   */
  public static MovesNorthWestMatch newMutableMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public static MovesNorthWestMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return new Immutable(pSquareStart, pSquareEnd, pSquareMiddle);
  }
  
  private static final class Mutable extends MovesNorthWestMatch {
  ...
  private static final class Immutable extends MovesNorthWestMatch {
