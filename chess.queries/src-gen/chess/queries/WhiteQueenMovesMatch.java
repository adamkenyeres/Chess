...
/**
 * Pattern-specific match representation of the chess.queries.whiteQueenMoves pattern,
 * to be used in conjunction with {@link WhiteQueenMovesMatcher}.
 * 
...
public abstract class WhiteQueenMovesMatch extends BasePatternMatch {
  ...
  private WhiteQueenMovesMatch(final Queen pQueen, final Square pSquare, final Chess pChess) {
    this.fQueen = pQueen;
  ...
  public List<String> parameterNames() {
    return WhiteQueenMovesMatch.parameterNames;
  }
  ...
  @Override
  public WhiteQueenMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WhiteQueenMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    WhiteQueenMovesMatch other = (WhiteQueenMovesMatch) obj;
  ...
  @Override
  public WhiteQueenMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WhiteQueenMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static WhiteQueenMovesMatch newMutableMatch(final Queen pQueen, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static WhiteQueenMovesMatch newMatch(final Queen pQueen, final Square pSquare, final Chess pChess) {
    return new Immutable(pQueen, pSquare, pChess);
  }
  
  private static final class Mutable extends WhiteQueenMovesMatch {
  ...
  private static final class Immutable extends WhiteQueenMovesMatch {
