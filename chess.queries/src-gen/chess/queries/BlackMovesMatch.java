...
public abstract class BlackMovesMatch extends BasePatternMatch {
  ...
  private BlackMovesMatch(final Piece pPiece, final Square pSquare) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static BlackMovesMatch newMutableMatch(final Piece pPiece, final Square pSquare) {
   ...
   * 
   */
  public static BlackMovesMatch newMatch(final Piece pPiece, final Square pSquare) {
