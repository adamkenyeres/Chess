...
/**
 * Pattern-specific match representation of the chess.queries.blackMoves pattern,
 * to be used in conjunction with {@link BlackMovesMatcher}.
 * 
...
public abstract class BlackMovesMatch extends BasePatternMatch {
  ...
  private BlackMovesMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return BlackMovesMatch.parameterNames;
  }
  ...
  @Override
  public BlackMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BlackMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BlackMovesMatch other = (BlackMovesMatch) obj;
  ...
  @Override
  public BlackMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BlackMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static BlackMovesMatch newMutableMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static BlackMovesMatch newMatch(final Piece pPiece, final Square pSquare, final Chess pChess) {
    return new Immutable(pPiece, pSquare, pChess);
  }
  
  private static final class Mutable extends BlackMovesMatch {
  ...
  private static final class Immutable extends BlackMovesMatch {
