...
/**
 * Pattern-specific match representation of the chess.queries.movesNorthEast pattern,
 * to be used in conjunction with {@link MovesNorthEastMatcher}.
 * 
...
public abstract class MovesNorthEastMatch extends BasePatternMatch {
  ...
  private MovesNorthEastMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
  ...
  public List<String> parameterNames() {
    return MovesNorthEastMatch.parameterNames;
  }
  ...
  @Override
  public MovesNorthEastMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MovesNorthEastMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MovesNorthEastMatch other = (MovesNorthEastMatch) obj;
  ...
  @Override
  public MovesNorthEastQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MovesNorthEastMatch newEmptyMatch() {
   ...
   * 
   */
  public static MovesNorthEastMatch newMutableMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public static MovesNorthEastMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return new Immutable(pSquareStart, pSquareEnd, pSquareMiddle);
  }
  
  private static final class Mutable extends MovesNorthEastMatch {
  ...
  private static final class Immutable extends MovesNorthEastMatch {
