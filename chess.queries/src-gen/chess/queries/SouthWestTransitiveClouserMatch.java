...
/**
 * Pattern-specific match representation of the chess.queries.southWestTransitiveClouser pattern,
 * to be used in conjunction with {@link SouthWestTransitiveClouserMatcher}.
 * 
...
public abstract class SouthWestTransitiveClouserMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private SouthWestTransitiveClouserMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return SouthWestTransitiveClouserMatch.parameterNames;
  }
  ...
  @Override
  public SouthWestTransitiveClouserMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SouthWestTransitiveClouserMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SouthWestTransitiveClouserMatch other = (SouthWestTransitiveClouserMatch) obj;
  ...
  @Override
  public SouthWestTransitiveClouserQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SouthWestTransitiveClouserMatch newEmptyMatch() {
   ...
   * 
   */
  public static SouthWestTransitiveClouserMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static SouthWestTransitiveClouserMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends SouthWestTransitiveClouserMatch {
  ...
  private static final class Immutable extends SouthWestTransitiveClouserMatch {
