...
/**
 * Generated pattern matcher API of the chess.queries.movesSouthWest pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link MovesSouthWestMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern
 ...
 * @see MovesSouthWestProcessor
 * @see MovesSouthWestQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class MovesSouthWestMatcher extends BaseMatcher<MovesSouthWestMatch> {
  /**
   ...
   * 
   */
  public static MovesSouthWestMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    MovesSouthWestMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new MovesSouthWestMatcher(engine);
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MovesSouthWestMatcher.class);
   ...
   * 
   */
  private MovesSouthWestMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * @return matches represented as a MovesSouthWestMatch object.
   * 
   */
  public Collection<MovesSouthWestMatch> getAllMatches(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * @param pSquareEnd the fixed value of pattern parameter squareEnd, or null if not bound.
   * @param pSquareMiddle the fixed value of pattern parameter squareMiddle, or null if not bound.
   * @return a match represented as a MovesSouthWestMatch object, or null if no match is found.
   * 
   */
  public MovesSouthWestMatch getOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesSouthWestMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesSouthWestMatch> processor) {
   ...
   * 
   */
  public MovesSouthWestMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return MovesSouthWestMatch.newMatch(pSquareStart, pSquareEnd, pSquareMiddle);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareStart(final MovesSouthWestMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareEnd(final MovesSouthWestMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareMiddle(final MovesSouthWestMatch partialMatch) {
  ...
  @Override
  protected MovesSouthWestMatch tupleToMatch(final Tuple t) {
    try {
    	return MovesSouthWestMatch.newMatch((Square) t.get(POSITION_SQUARESTART), (Square) t.get(POSITION_SQUAREEND), (Square) t.get(POSITION_SQUAREMIDDLE));
  ...
  @Override
  protected MovesSouthWestMatch arrayToMatch(final Object[] match) {
    try {
    	return MovesSouthWestMatch.newMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected MovesSouthWestMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return MovesSouthWestMatch.newMutableMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<MovesSouthWestMatcher> querySpecification() throws ViatraQueryException {
