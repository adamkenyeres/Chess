...
/**
 * Generated pattern matcher API of the chess.queries.movesEast pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(ViatraQueryEngine)},
 * e.g. in conjunction with {@link ViatraQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link MovesEastMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * 
 * @see MovesEastMatch
 * @see MovesEastProcessor
 * @see MovesEastQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class MovesEastMatcher extends BaseMatcher<MovesEastMatch> {
  /**
   ...
   * 
   */
  public static MovesEastMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    MovesEastMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new MovesEastMatcher(engine);
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MovesEastMatcher.class);
   ...
   * 
   */
  private MovesEastMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
   ...
   * @return matches represented as a MovesEastMatch object.
   * 
   */
  public Collection<MovesEastMatch> getAllMatches(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * @param pSquareEnd the fixed value of pattern parameter squareEnd, or null if not bound.
   * @param pSquareMiddle the fixed value of pattern parameter squareMiddle, or null if not bound.
   * @return a match represented as a MovesEastMatch object, or null if no match is found.
   * 
   */
  public MovesEastMatch getOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public void forEachMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesEastMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle, final IMatchProcessor<? super MovesEastMatch> processor) {
   ...
   * 
   */
  public MovesEastMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return MovesEastMatch.newMatch(pSquareStart, pSquareEnd, pSquareMiddle);
  }
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareStart(final MovesEastMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareEnd(final MovesEastMatch partialMatch) {
   ...
   * 
   */
  public Set<Square> getAllValuesOfsquareMiddle(final MovesEastMatch partialMatch) {
  ...
  @Override
  protected MovesEastMatch tupleToMatch(final Tuple t) {
    try {
    	return MovesEastMatch.newMatch((Square) t.get(POSITION_SQUARESTART), (Square) t.get(POSITION_SQUAREEND), (Square) t.get(POSITION_SQUAREMIDDLE));
  ...
  @Override
  protected MovesEastMatch arrayToMatch(final Object[] match) {
    try {
    	return MovesEastMatch.newMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected MovesEastMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return MovesEastMatch.newMutableMatch((Square) match[POSITION_SQUARESTART], (Square) match[POSITION_SQUAREEND], (Square) match[POSITION_SQUAREMIDDLE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<MovesEastMatcher> querySpecification() throws ViatraQueryException {
