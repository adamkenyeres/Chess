...
/**
 * Pattern-specific match representation of the chess.queries.blackKingMoves pattern,
 * to be used in conjunction with {@link BlackKingMovesMatcher}.
 * 
...
public abstract class BlackKingMovesMatch extends BasePatternMatch {
  private King fKing;
  ...
  private BlackKingMovesMatch(final King pKing, final Square pSquare, final Chess pChess) {
    this.fKing = pKing;
  ...
  public List<String> parameterNames() {
    return BlackKingMovesMatch.parameterNames;
  }
  ...
  @Override
  public BlackKingMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BlackKingMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    BlackKingMovesMatch other = (BlackKingMovesMatch) obj;
  ...
  @Override
  public BlackKingMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BlackKingMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static BlackKingMovesMatch newMutableMatch(final King pKing, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static BlackKingMovesMatch newMatch(final King pKing, final Square pSquare, final Chess pChess) {
    return new Immutable(pKing, pSquare, pChess);
  }
  
  private static final class Mutable extends BlackKingMovesMatch {
  ...
  private static final class Immutable extends BlackKingMovesMatch {
