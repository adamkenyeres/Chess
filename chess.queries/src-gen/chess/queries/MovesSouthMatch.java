...
/**
 * Pattern-specific match representation of the chess.queries.movesSouth pattern,
 * to be used in conjunction with {@link MovesSouthMatcher}.
 * 
...
public abstract class MovesSouthMatch extends BasePatternMatch {
  ...
  private MovesSouthMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
  ...
  public List<String> parameterNames() {
    return MovesSouthMatch.parameterNames;
  }
  ...
  @Override
  public MovesSouthMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MovesSouthMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MovesSouthMatch other = (MovesSouthMatch) obj;
  ...
  @Override
  public MovesSouthQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MovesSouthMatch newEmptyMatch() {
   ...
   * 
   */
  public static MovesSouthMatch newMutableMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public static MovesSouthMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return new Immutable(pSquareStart, pSquareEnd, pSquareMiddle);
  }
  
  private static final class Mutable extends MovesSouthMatch {
  ...
  private static final class Immutable extends MovesSouthMatch {
