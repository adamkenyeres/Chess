...
/**
 * Pattern-specific match representation of the chess.queries.vSouth pattern,
 * to be used in conjunction with {@link VSouthMatcher}.
 * 
...
public abstract class VSouthMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private VSouthMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return VSouthMatch.parameterNames;
  }
  ...
  @Override
  public VSouthMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof VSouthMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    VSouthMatch other = (VSouthMatch) obj;
  ...
  @Override
  public VSouthQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static VSouthMatch newEmptyMatch() {
   ...
   * 
   */
  public static VSouthMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static VSouthMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends VSouthMatch {
  ...
  private static final class Immutable extends VSouthMatch {
