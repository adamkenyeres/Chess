...
/**
 * Pattern-specific match representation of the chess.queries.movesNorth pattern,
 * to be used in conjunction with {@link MovesNorthMatcher}.
 * 
...
public abstract class MovesNorthMatch extends BasePatternMatch {
  ...
  private MovesNorthMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
  ...
  public List<String> parameterNames() {
    return MovesNorthMatch.parameterNames;
  }
  ...
  @Override
  public MovesNorthMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MovesNorthMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MovesNorthMatch other = (MovesNorthMatch) obj;
  ...
  @Override
  public MovesNorthQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MovesNorthMatch newEmptyMatch() {
   ...
   * 
   */
  public static MovesNorthMatch newMutableMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
   ...
   * 
   */
  public static MovesNorthMatch newMatch(final Square pSquareStart, final Square pSquareEnd, final Square pSquareMiddle) {
    return new Immutable(pSquareStart, pSquareEnd, pSquareMiddle);
  }
  
  private static final class Mutable extends MovesNorthMatch {
  ...
  private static final class Immutable extends MovesNorthMatch {
