...
/**
 * Pattern-specific match representation of the chess.queries.square pattern,
...
public abstract class SquareMatch extends BasePatternMatch {
  ...
  public void setSource(final Piece pSource) {
    if (!isMutable()) throw new java.lang.UnsupportedOperationException();
    this.fSource = pSource;
  }
   ...
   * 
   */
  public static SquareMatch newMutableMatch(final Piece pSource, final Square pTarget) {
   ...
   * 
   */
  public static SquareMatch newMatch(final Piece pSource, final Square pTarget) {
    return new Immutable(pSource, pTarget);
  }
  
  private static final class Mutable extends SquareMatch {
    Mutable(final Piece pSource, final Square pTarget) {
  ...
  private static final class Immutable extends SquareMatch {
    Immutable(final Piece pSource, final Square pTarget) {
      super(pSource, pTarget);
    }
