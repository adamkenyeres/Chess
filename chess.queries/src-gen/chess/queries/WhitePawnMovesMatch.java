...
public abstract class WhitePawnMovesMatch extends BasePatternMatch {
  ...
  private WhitePawnMovesMatch(final Pawn pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static WhitePawnMovesMatch newMutableMatch(final Pawn pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static WhitePawnMovesMatch newMatch(final Pawn pPiece, final Square pSquare, final Chess pChess) {
