...
/**
 * Pattern-specific match representation of the chess.queries.whitePawnMoves pattern,
 * to be used in conjunction with {@link WhitePawnMovesMatcher}.
 * 
...
public abstract class WhitePawnMovesMatch extends BasePatternMatch {
  private Pawn fPiece;
  ...
  private WhitePawnMovesMatch(final Pawn pPiece, final Square pSquare) {
    this.fPiece = pPiece;
  ...
  public List<String> parameterNames() {
    return WhitePawnMovesMatch.parameterNames;
  }
  ...
  @Override
  public WhitePawnMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WhitePawnMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    WhitePawnMovesMatch other = (WhitePawnMovesMatch) obj;
  ...
  @Override
  public WhitePawnMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WhitePawnMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static WhitePawnMovesMatch newMutableMatch(final Pawn pPiece, final Square pSquare) {
   ...
   * 
   */
  public static WhitePawnMovesMatch newMatch(final Pawn pPiece, final Square pSquare) {
    return new Immutable(pPiece, pSquare);
  }
  
  private static final class Mutable extends WhitePawnMovesMatch {
    Mutable(final Pawn pPiece, final Square pSquare) {
  ...
  private static final class Immutable extends WhitePawnMovesMatch {
    Immutable(final Pawn pPiece, final Square pSquare) {
      super(pPiece, pSquare);
    }
