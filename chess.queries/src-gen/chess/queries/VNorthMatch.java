...
/**
 * Pattern-specific match representation of the chess.queries.vNorth pattern,
 * to be used in conjunction with {@link VNorthMatcher}.
 * 
...
public abstract class VNorthMatch extends BasePatternMatch {
  private Square fS1;
  ...
  private VNorthMatch(final Square pS1, final Square pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public String patternName() {
    return "chess.queries.vNorth";
  }
  
  @Override
  public List<String> parameterNames() {
    return VNorthMatch.parameterNames;
  }
  ...
  @Override
  public VNorthMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof VNorthMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    VNorthMatch other = (VNorthMatch) obj;
  ...
  @Override
  public VNorthQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static VNorthMatch newEmptyMatch() {
   ...
   * 
   */
  public static VNorthMatch newMutableMatch(final Square pS1, final Square pS2) {
   ...
   * 
   */
  public static VNorthMatch newMatch(final Square pS1, final Square pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends VNorthMatch {
  ...
  private static final class Immutable extends VNorthMatch {
