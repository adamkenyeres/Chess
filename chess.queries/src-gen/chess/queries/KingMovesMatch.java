...
public abstract class KingMovesMatch extends BasePatternMatch {
  ...
  private KingMovesMatch(final King pKing, final Square pSquare, final Chess pChess) {
    this.fKing = pKing;
   ...
   * 
   */
  public static KingMovesMatch newMutableMatch(final King pKing, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static KingMovesMatch newMatch(final King pKing, final Square pSquare, final Chess pChess) {
