...
/**
 * Pattern-specific match representation of the chess.queries.whiteKnightMoves pattern,
 * to be used in conjunction with {@link WhiteKnightMovesMatcher}.
 * 
...
public abstract class WhiteKnightMovesMatch extends BasePatternMatch {
  private Knight fPiece;
  ...
  private WhiteKnightMovesMatch(final Knight pPiece, final Square pSquare, final Chess pChess) {
    this.fPiece = pPiece;
  ...
  public void setPiece(final Knight pPiece) {
    if (!isMutable()) throw new java.lang.UnsupportedOperationException();
    this.fPiece = pPiece;
  }
  ...
  public List<String> parameterNames() {
    return WhiteKnightMovesMatch.parameterNames;
  }
  ...
  @Override
  public WhiteKnightMovesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof WhiteKnightMovesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    WhiteKnightMovesMatch other = (WhiteKnightMovesMatch) obj;
  ...
  @Override
  public WhiteKnightMovesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static WhiteKnightMovesMatch newEmptyMatch() {
   ...
   * 
   */
  public static WhiteKnightMovesMatch newMutableMatch(final Knight pPiece, final Square pSquare, final Chess pChess) {
   ...
   * 
   */
  public static WhiteKnightMovesMatch newMatch(final Knight pPiece, final Square pSquare, final Chess pChess) {
    return new Immutable(pPiece, pSquare, pChess);
  }
  
  private static final class Mutable extends WhiteKnightMovesMatch {
  ...
  private static final class Immutable extends WhiteKnightMovesMatch {
