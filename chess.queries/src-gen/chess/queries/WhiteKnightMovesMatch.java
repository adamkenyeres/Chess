...
public abstract class WhiteKnightMovesMatch extends BasePatternMatch {
  ...
  private WhiteKnightMovesMatch(final Knight pPiece, final Square pSquare) {
    this.fPiece = pPiece;
   ...
   * 
   */
  public static WhiteKnightMovesMatch newMutableMatch(final Knight pPiece, final Square pSquare) {
   ...
   * 
   */
  public static WhiteKnightMovesMatch newMatch(final Knight pPiece, final Square pSquare) {
