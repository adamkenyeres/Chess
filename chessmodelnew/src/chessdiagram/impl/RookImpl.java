 ...
 * </p>
 * <ul>
 *   <li>{@link chessdiagram.impl.RookImpl#isFirstMove <em>First Move</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RookImpl extends PieceImpl implements Rook {
	...
	protected EClass eStaticClass() {
		return ChessdiagramPackage.Literals.ROOK;
	}
	...
	public void setFirstMove(boolean newFirstMove) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChessdiagramPackage.ROOK__FIRST_MOVE, oldFirstMove, firstMove));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChessdiagramPackage.ROOK__FIRST_MOVE:
				return isFirstMove();
		}
